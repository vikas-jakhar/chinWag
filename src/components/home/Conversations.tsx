...
const Conversations: React.FC = () => {
    return (
        <div className='lg:py-24 py-11 md:py-16 relative z-[1] bg-lightSky'>
                    ...
                    {CONVERSATIONS_DATA.map((item: CardDataItem, index: number) => (
                        ...
                        >
                            ...
                            <PrimaryButton
                                ...
                                text={item.button}
                                className={`${index === 0 ? "text-offGreen bg-mediumGreen" : "text-white bg-darkGreen"} sm:mt-[34px] mt-6 w-full text-xs py-3 sm:py-[14px] rounded-[138px] font-bold`}
                            />
                        </div>
                    ))}
                </div>
