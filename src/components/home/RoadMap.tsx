        ...
        <div className='sm:py-24 pt-16 pb-24 relative z-[1]'>
            <div className="container sm:mt-9 lg:pb-16 sm:mb-5">
                ...
                <div className="lg:mt-40 mt-12 pt-3 gap-7 sm:gap-0 lg:max-h-[368px] flex lg:flex-row flex-col justify-between max-w-[1074px] w-full mx-auto pointer-events-none relative z-10">
                    <Image src="/assets/images/webp/green-line.png" className='w-full absolute -z-[1] hidden lg:flex top-0 left-1/2 -translate-x-1/2 max-w-[877px]' width={1074} height={371} alt='partnerships' priority />
                    <Image src="/assets/images/webp/green-line-img.png" className='h-[80%] w-1.5 absolute -z-[1] lg:hidden top-1/2 -translate-y-1/2 left-[11%] sm:left-24' width={1074} height={371} alt='partnerships' priority />
