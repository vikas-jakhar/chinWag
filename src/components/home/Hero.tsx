      ...
      <div className='container relative'>
        <div className='flex justify-between items-center flex-wrap max-xl:justify-center max-sm:items-center max-xl:text-center pt-[213px] max-sm:pt-[119px] pb-[141px] max-md:pb-[50px] max-sm:pb-[0px] max-xl:pb-[60px]'>
          ...
          <div className='flex flex-col max-xl:pt-16 max-sm:pt-[23px] max-xl:text-center max-xl:items-center'>
            ...
            <PrimaryButton hoverClass='bg-light-green' text='Publish your Requirement' className='font-normal border-[1px] border-transparent hover:border-light-green max-sm:text-xs max-sm:py-[10px] max-sm:px-[15px] max-sm:mt-[21px] leading-5 max-w-[237px] text-nowrap text-white rounded-[65px] bg-dark-green py-[14px] px-[20px] mt-[29px]' />
          </div>
        </div>
      </div>
