  ...
  return (
    <div className='relative'>
      ...
      <div className='container relative'>
        <div className='flex justify-between gap_20 max-xl:flex-wrap max-xl:justify-center max-sm:items-center max-xl:text-center pt-[213px] max-sm:pt-[119px] pb-[141px] max-md:pb-[50px] max-sm:pb-[71px] max-xl:pb-[60px] max-sm:pb-0 items-center'>
          ...
          <div className='flex flex-col max-xl:pt-10 max-sm:pt-[3px] max-xl:text-center max-xl:items-center'>
            ...
            <button className='font-bold border-[1px] border-transparent hover:border-offGreen duration-500 hover:bg-white hover:text-offGreen text-base max-sm:mt-[21px] leading-5 max-w-[237px] text-nowrap text-white rounded-[65px] bg-darkGreen py-[16px] px-[20px] mt-[41px]'>Publish your Requirement</button>
          </div>
        </div>
      ...
      <div className='2xl:hidden'>
        <div className='flex flex-col gap-[17px] max-sm:gap-[5px] max-md:left-[10px] max-sm:top-[225px] max-md:top-[420px] absolute right-[15px] top-[107px]'>
