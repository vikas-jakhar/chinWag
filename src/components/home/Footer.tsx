  ...
  return (
    <div className="pb-0.5 pt-4 sm:py-5 bg-footer-layer bg-no-repeat bg-cover">
      <div className="container mt-5 relative z-[1]">
        <Link
          href="/"
          className="sm:max-w-[206px] items-center justify-end min-h-[113px] sm:min-h-[199px] h-full max-w-[108px] relative w-full flex mx-auto flex-col"
        >
          <Image
            ...
            priority
          />
          <p className="text-xs md:text-xl font-medium tracking-widest relative text-medium-green">
            CHIN-WAG{" "}
            <span className="absolute -top-0.5 -right-2.5 text-xs">®</span>
          </p>
        </Link>
        <PrimaryButton
          gsapClass="mx-auto"
      ...
      <p className="pt-5 w-full text-center text-white font-normal text-xs sm:text-sm opacity-60 border-t mt-8 border-off-gray hidden sm:block">
        © CHIN WAG INTERNATIONAL LIMITED t/a Chin-wag.com {currentYear}, All
        Rights Reserved.
      </p>
